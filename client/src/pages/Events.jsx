    ...
    <div className={ eventDetailHeroStyles.container}>
       <div className={ eventDetailHeroStyles.gridContainer}>
        ...
        <div className={ eventDetailHeroStyles.workshopContainer}>
          <button className={ eventDetailHeroStyles.workshopButton}>
        ...
        <div className={ eventDetailHeroStyles.registerContainer}>
          <button className={ eventDetailHeroStyles.registerButton}>Register</button>
        </div>
        </div>
        <div className={ eventDetailHeroStyles.footer}>
          <div className={ eventDetailHeroStyles.ColumnFooter}>
            ...
            height:'50%'
             ...
             <div className={ eventDetailHeroStyles.footerContent}>
                <img src={require('./assets/Calendar.png')} className={ eventDetailHeroStyles.pngimage}></img>
             </div>
            </div>
            <div style={{
              height:'25%',
          ...
          <div className={ eventDetailHeroStyles.ColumnFooter}>
            ...
            height:'50%'
               ...
               <div className={ eventDetailHeroStyles.footerContent}>
               <img src={require('./assets/Clock.png')} className={ eventDetailHeroStyles.pngimage}></img>
              </div>
            </div>
          ...
          <div className={ eventDetailHeroStyles.ColumnFooter}>
            ...
            height:'50%'
              ...
              <div className={ eventDetailHeroStyles.footerContent}>
              <img src={require('./assets/Map Marker.png')} className={ eventDetailHeroStyles.pngimage}></img>
              </div>
            </div>
            <div style={{
              height:'25%',
